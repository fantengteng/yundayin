...
- (instancetype)initWithGroupItems:(NSArray *)groupItems {
    ...
    _pager.height = 10;
    IPhoneXHeigh
    _pager.center = CGPointMake(self.width / 2, self.height - 18 - security_H);
...
- (UIButton *)baocun {
    if (!_baocun) {
        ...
        _baocun.frame = CGRectMake([UIScreen mainScreen].bounds.size.width - 40, [UIScreen mainScreen].bounds.size.height - 60 - security_H, 40, 40);
        [_baocun setImage:[UIImage imageNamed:@"baocun"] forState:UIControlStateNormal];
